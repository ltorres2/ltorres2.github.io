...
var style_NMHispanicPopulation2014_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("pop_hispltxE");
    var labelText = "";
    size = 0;
    ...
    if (value >= 4.000000 && value <= 1605.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1605.200000 && value <= 3206.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3206.400000 && value <= 4807.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4807.600000 && value <= 6408.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6408.800000 && value <= 8010.000000) {
            style = [ new ol.style.Style({
